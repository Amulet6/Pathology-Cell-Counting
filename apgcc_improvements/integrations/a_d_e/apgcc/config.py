...
_C.MODEL.FOCAL_GAMMA = 0.0 # Direction-A: softmax-focal modulation on proposal cls loss; 0.0 == plain weighted CE
...
# Direction-E: pathology / stain augmentation (train-only)
_C.DATALOADER.PATHOLOGY_AUG = False     # master switch for stain/pathology augmentation
_C.DATALOADER.STAIN_JITTER = False      # brightness/contrast/color + per-channel scale/bias jitter
_C.DATALOADER.BLUR_NOISE = False        # light optional gaussian blur / gaussian noise
_C.DATALOADER.DOMAIN_NAMES = ['crag', 'dpath', 'glas', 'pannuke', 'consep']  # CoNIC source domains

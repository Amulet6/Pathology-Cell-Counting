...
_C.MODEL.DOMAIN_ADAPTATION = False
_C.MODEL.DOMAIN_LOSS_WEIGHT = 0.01
_C.MODEL.DOMAIN_NUM_CLASSES = 5
_C.MODEL.DOMAIN_GRL_LAMBDA = 1.0
_C.MODEL.DOMAIN_GRL_WARMUP_EPOCHS = 0
_C.MODEL.DOMAIN_GRL_RAMP_EPOCHS = 0
_C.MODEL.DOMAIN_HIDDEN_DIM = 256
_C.MODEL.HARD_DENSITY_REWEIGHT = False
_C.MODEL.HARD_DENSITY_THRESHOLDS = [12, 25]
_C.MODEL.HARD_DENSITY_WEIGHTS = [1.0, 1.25, 1.6]
_C.MODEL.HARD_DOMAIN_NAMES = ['glas', 'pannuke']
_C.MODEL.HARD_DOMAIN_WEIGHT = 1.25
_C.MODEL.HARD_DOMAIN_MIN_POINTS = 12
...
_C.SOLVER.EARLY_STOP_PATIENCE = -1 # disabled when < 0; counted in validation rounds
_C.SOLVER.EARLY_STOP_MIN_DELTA = 0.0 # minimum MAE improvement required to reset patience
# ---------------------------------------------------------------------------- #
# Matcher
# ---------------------------------------------------------------------------- #
_C.MATCHER = edict()

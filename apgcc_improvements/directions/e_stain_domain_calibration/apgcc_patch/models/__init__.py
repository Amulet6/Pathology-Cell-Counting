...
def build_model(cfg, training):
   ...
   if getattr(cfg.MODEL, 'DOMAIN_ADAPTATION', False):
      weight_dict['loss_domain'] = cfg.MODEL.DOMAIN_LOSS_WEIGHT
   ...
   criterion = SetCriterion_Crowd(num_classes=1, \
                                  ...
                                  domain_adaptation=getattr(cfg.MODEL, 'DOMAIN_ADAPTATION', False))

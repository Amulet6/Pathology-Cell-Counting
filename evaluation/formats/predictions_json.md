...
| 数据集 | 脚本 | 命令 |
|------|------|------|
| MoNuSeg | `label_to_centroids.py monuseg` | `python label_to_centroids.py monuseg --xml_root <path> --output <out>` |
| CoNIC | `label_to_centroids.py conic` | `python label_to_centroids.py conic --labels_npy <path> --output <out>` |

...
class Model_builder(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        # APGCC training passes a plain tensor batch here, not a NestedTensor wrapper.
...
class SetCriterion_Crowd(nn.Module):
    ...
    def __init__(self, num_classes, matcher, weight_dict, eos_coef, aux_kwargs, dense_aux_en=False, dense_sigma=2.0):

...
def get_args_parser():
    ...
    parser.add_argument('--image_set', default='val', choices=['val', 'test'])
...
def main(args):
    ...
    test_stats = evaluate(model, data_loader_val, device, vis_dir=vis_dir, loc_radius=args.loc_radius)
    ...
    line = f'\nepoch: {cur_epoch}, mae: {mae}, mse: {mse}, precision: {precision}, recall: {recall}, f1: {f1}'
    print(line)

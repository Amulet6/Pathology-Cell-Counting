...
class Config(object):
    ...
    def __init__(self):
        ...
        nr_type = None # no type classification for MoNuSeg/Kumar
        ...
        self.log_dir = "logs/monuseg_unified/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "dataset/training_data/monuseg/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
            "dataset/training_data/monuseg/valid/540x540_164x164/"
        ]
